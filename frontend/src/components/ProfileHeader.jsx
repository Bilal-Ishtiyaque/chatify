...
import { LogOutIcon, VolumeOffIcon, Volume2Icon, LoaderCircle  } from "lucide-react";
    ...
    <div className="p-6 border-b border-slate-700/50">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          {/* AVATAR */}
          <div className="avatar online"> {/*daisy ui classes avatar, online*/}
            ...
            <button className="size-14 rounded-full overflow-hidden relative group" onClick={() => fileInputRef.current.click()}>
              ...
              <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                <span className="text-white text-xs">{ isImageUploading ? <LoaderCircle/> : "Change"}</span>
              </div>
            </button>
